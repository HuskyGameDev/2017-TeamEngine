...
public enum Primitive {
    ...
    /**
     * Draw line strip, first line uses two vertices, and each line after uses
     * the last vertex and one more
     */
    LINE_STRIP(2),
    ...
    /**
     * Draw triangle strip, first triangle uses three vertices, and each
     * triangle after uses the last two vertices and one more
     */
    TRIANGLE_STRIP(3);
